...
CREATE TABLE `result` (
  ...
  `paper1` int(255) NOT NULL,
  `paper2` int(255) NOT NULL,
  `paper3` int(255) NOT NULL,
  `paper4` int(255) NOT NULL,
...
INSERT INTO `result` (`id`, `name`, `roll`, `fname`, `dob`, `contact`, `imgpath`, `paper1`, `paper2`, `paper3`, `paper4`, `total_marks`) VALUES
